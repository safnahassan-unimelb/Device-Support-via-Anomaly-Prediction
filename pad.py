...
def get_dataset(args):
    ...
    loc, input_size = iotDataset.get_data(args.win_size, args.forecast_window, args.step_size, args.missing_rate)
...
def evaluate(args,mode,eval_dataloader,epoch):
    ...
    for batch in eval_dataloader:
        ...
        loss = torch.nn.functional.binary_cross_entropy_with_logits(binary_prediction.cuda().unsqueeze(1), batch_y)
        next_loss = torch.nn.functional.binary_cross_entropy_with_logits(next_binary_prediction.cuda().unsqueeze(1), next_y)
